        ...
        <div key={index}>
          ...
          {inputValue[operation[1]] === '1' ? (
            <List>
              ...
              <InputItem
                {...getFieldProps(operation[3], {onChange: (value) => onChangeHandler(operation[3], value), rules: [{required: true, message: '请输入手术量'}]})}
                type="text"
              ...
              <InputItem
                {...getFieldProps(operation[4], {onChange: (value) => onChangeHandler(operation[4], value), rules: [{required: true, message: '请输入手术量'}]})}
                type="text"
              ...
              <InputItem
                {...getFieldProps(operation[5], {onChange: (value) => onChangeHandler(operation[5], value), rules: [{required: true, message: '请输入手术量'}]})}
                type="text"
              ...
              <InputItem
                {...getFieldProps(operation[6], {onChange: (value) => onChangeHandler(operation[6], value), rules: [{required: true, message: '请输入手术量'}]})}
                type="text"
              ...
              <InputItem
                {...getFieldProps(operation[7], {onChange: (value) => onChangeHandler(operation[7], value), rules: [{required: true, message: '请输入手术量'}]})}
                type="text"
              ...
              <InputItem
                {...getFieldProps(operation[8], {onChange: (value) => onChangeHandler(operation[8], value), rules: [{required: true, message: '请输入手术量'}]})}
                type="text"
    ...
    return (
      <React.Fragment>
        ...
        <List>
          ...
          <p className='info_content'>2、导管室人员中最紧缺的是？<span>*</span> </p>
          ...
          {CHDCheckOtherOffice.map(i => (
            <RadioItem
              {...getFieldProps('CHDCheckOtherOffice', {rules: [{required: true, message: '请选择导管室工作经常加班吗？'}]})}
              key={i.value}
          ...
          {pipeNumberWork.map(i => (
            <CheckboxItem
              {...getFieldProps('pipeNumberWork', {rules: [{required: true, message: '请选择冠心病造影检查除了心脏科是否其他科室也开展？'}]})}
              key={i.value}
              checked={i.value === inputValue.pipeNumberWork}
              // error={isFieldTouched('pipeNumberWork') && getFieldError('pipeNumberWork')}
              // onErrorClick={() => Toast.info(getFieldError('pipeNumberWork'))}
          ...
          <InputItem
            {...getFieldProps('currentPipeWorkHardest', {onChange: (value) => onChangeHandler('currentPipeWorkHardest', value), rules: [{required: true, message: '请输入科主任姓名'}]})}
            type="text"
          ...
          <InputItem
            {...getFieldProps('adviceTrainingProgram', {onChange: (value) => onChangeHandler('adviceTrainingProgram', value), rules: [{required: true, message: '请输入科主任姓名'}]})}
            type="text"
          ...
          <InputItem
            {...getFieldProps('adviceAdministration', {onChange: (value) => onChangeHandler('adviceAdministration', value), rules: [{required: true, message: '请输入科主任姓名'}]})}
            type="text"
