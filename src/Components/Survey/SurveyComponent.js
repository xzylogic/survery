...
class Index extends React.Component {
  ...
  render() {
    let sealImg = `${process.env.PUBLIC_URL}/images/WechatIMG8.png`;
    return (
      <div className='survey'>
        <div className='survey_logo'>
          <img style={{width: '4rem'}} src={`${process.env.PUBLIC_URL}/images/WechatIMG5.jpeg`} alt="调查表logo"/>
        </div>
        <h3 className='survey_title'>调查表</h3>
        <div style={{background: `url(${sealImg}) no-repeat right bottom`, backgroundSize: '4.5rem 4.5rem'}}>
          <p
